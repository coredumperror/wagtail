...
from wagtail.admin.navigation import get_explorable_root_page, get_manageable_root_collection
...
def collection_chooser(context, collections, collection_chooser_label='Collection', selected_collection=None,
                       show_all_collections=True, field_name='collection_id', enable_widget_mode=False):
    """
    ...
    context.update({
        ...
        'label': collection_chooser_label,
